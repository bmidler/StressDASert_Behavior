...
# Run sleap inference.
sleap-track -o $tracks_file_path --tracking.tracker simple --peak_threshold 0.3 --tracking.track_window 3 --tracking.post_connect_single_breaks 1 --tracking.similarity instance --tracking.clean_instance_count 1 --model $centroid_model --model  $centered_model $video
